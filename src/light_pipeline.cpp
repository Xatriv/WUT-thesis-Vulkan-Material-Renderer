...
void LightPipeline::createVertexBuffer() {
    std::vector<BasicVertex> podVertices;
    for (const auto& variant : _vertices) {
        if (const BasicVertex* pval = std::get_if<BasicVertex>(&variant)) {
