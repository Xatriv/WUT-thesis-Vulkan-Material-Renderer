...
/usr/local/bin/glslc shaders/light_shader.vert -o shaders/light_shader.vert.spv
/usr/local/bin/glslc shaders/light_shader.frag -o shaders/light_shader.frag.spv
